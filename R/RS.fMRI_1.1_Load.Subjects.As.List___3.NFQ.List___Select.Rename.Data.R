RS.fMRI_1.1_Load.Subjects.As.List___3.NFQ.List___Select.Rename.Data = function(NFQ.df){
  ### selection
  df1 = NFQ.df %>% dplyr::select(-starts_with(c("WADDMN", "WVDMN", "WPDMN", "WAVDMN")))
  df2 = df1 %>% dplyr::select(-c("PATIENTSAGE", "SERIESNUMBER", "ECHOTIME", "UPDATE_STAMP"))
