RS.fMRI_1.5_Exporting.Lists___Export.Each.Manufacturer.Info___Export.Divided.List = function(data.list,
                                                                                             index=NULL,
                                                                                             Manufacturer,
  ...
  RS.fMRI_1.5_Exporting.Lists___SUB_Exporting.Image.ID(ID, filename, sub_path)


  ### csv file ==========================================================================
  EPB.csv = paste0("[Final_Selected]_Subjects_list_EPB_(",list_names, ")")
  MT1.csv = paste0("[Final_Selected]_Subjects_list_MT1_(",list_names, ")")
  RS.fMRI_1.5_Exporting.Lists___SUB_Exporting.Subjects.List.CSV(EPB, sub_path, EPB.csv)
  RS.fMRI_1.5_Exporting.Lists___SUB_Exporting.Subjects.List.CSV(MT1, sub_path, MT1.csv)


  ### Exporting SliceOrderInfo ==========================================================================
  filename = paste0("SliceOrderInfo(",list_names, ")")
  RS.fMRI_1.5_Exporting.Lists___SUB_Export.SliceOrderInfo(path = sub_path, EPB = EPB, filename = filename)


  ### Exporting subjects for SNP ==========================================================================
  filename = paste0("[Final_Selected]_keep_RID_for_SNP", "_(", list_names,")")
  RS.fMRI_1.5_Exporting.Lists___SUB_Exporting.RID.for.SNP(EPB, sub_path, filename)
