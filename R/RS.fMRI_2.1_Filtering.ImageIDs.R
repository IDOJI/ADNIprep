RS.fMRI_2.1_Filtering.ImageIDs = function(path_Old.Subjects.List.Folder = "C:/Users/lleii/Dropbox/Github/Rpkgs/ADNIprep/Subjects_Lists_Exported_OLD/0.All_Subjects",
  ...
  if(length(ImageID_To_Download)>0){
  ...
  #=============================================================================
  # Renaming unzipped folders : rename the excluded image IDs' folders
  #=============================================================================
  if(length(ImageID_To_Download)>0){
  ...
  cat("\n", crayon::yellow("STEP 2.1 : Filtering New ImageID & moving old folders is done!"), "\n")
}
