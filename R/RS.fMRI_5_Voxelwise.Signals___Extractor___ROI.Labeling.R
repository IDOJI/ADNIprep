RS.fMRI_5_Voxelwise.Signals___Extractor___ROI.Labeling = function(ith_Voxelwise_BOLD_Signals_Grouped_by_ROIs.list, ith_path_ROI_Order_Keys , Atlas){
  ...
  if(Atlas == "AAL1"){
    ...
    atlas_Labels = c("Precentral_L", "Precentral_R",
                     "Frontal_Sup_2_L", "Frontal_Sup_2_R",
                     "Frontal_Mid_2_L", "Frontal_Mid_2_R",
                     "Frontal_Inf_Oper_L", "Frontal_Inf_Oper_R", "Frontal_Inf_Tri_L", "Frontal_Inf_Tri_R", "Frontal_Inf_Orb_2_L", "Frontal_Inf_Orb_2_R",
                     ...
                     "Rectus_L", "Rectus_R",
                     "OFCmed_L", "OFCmed_R", "OFCant_L", "OFCant_R", "OFCpost_L", "OFCpost_R", "OFClat_L", "OFClat_R",
                     "Insula_L", "Insula_R",
  ...
  Cerebellum_Crus1_L Cerebellum_Crus1_R Cerebellum_Crus2_L Cerebellum_Crus2_R Cerebellum_3_L Cerebellum_3_R Cerebellum_4_5_L Cerebellum_4_5_R Cerebellum_6_L Cerebellum_6_R Cerebellum_7b_L Cerebellum_7b_R Cerebellum_8_L Cerebellum_8_R Cerebellum_9_L Cerebellum_9_R Cerebellum_10_L Cerebellum_10_R Vermis_1_2 Vermis_3 Vermis_4_5 Vermis_6 Vermis_7 Vermis_8 Vermis_9 Vermis_10 Thal_AV_L Thal_AV_R Thal_LP_L Thal_LP_R Thal_VA_L Thal_VA_R Thal_VL_L Thal_VL_R Thal_VPL_L Thal_VPL_R Thal_IL_L Thal_IL_R Thal_MDm_L Thal_MDm_R Thal_MDl_L Thal_MDl_R Thal_LGN_L Thal_LGN_R Thal_MGN_L Thal_MGN_R Thal_PuI_L Thal_PuI_R Thal_PuM_L Thal_PuM_R Thal_PuA_L Thal_PuA_R Thal_PuL_L Thal_PuL_R ACC_sub_L ACC_sub_R ACC_pre_L ACC_pre_R ACC_sup_L ACC_sup_R N_Acc_L N_Acc_R VTA_L VTA_R SN_pc_L SN_pc_R SN_pr_L SN_pr_R Red_N_L Red_N_R LC_L LC_R Raphe_D Raphe_M
  ...
  #=============================================================================
  if(length(ith_Voxelwise_BOLD_Signals_Grouped_by_ROIs.list) == length(ith_Defined_atlas_Labels )){
    names(ith_Voxelwise_BOLD_Signals_Grouped_by_ROIs.list) = ith_Defined_atlas_Labels
  }else{
  ...
  return(ith_Voxelwise_BOLD_Signals_Grouped_by_ROIs.list)
}
