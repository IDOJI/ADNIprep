RS.fMRI_3.1.Check.NIFTI.Converting___Extracting.Which.Subjects = function(manu_path, path_Subjects){
  ...
  #===========================================================================
  which_Fun_sub_dont_have_nii = RS.fMRI_3.1.Check.NIFTI.Converting___Extracting.Which.Subjects___Which.Dont.Have.Nii(FunImg_path, FunImg_folders)
  which_MT1_sub_dont_have_nii = RS.fMRI_3.1.Check.NIFTI.Converting___Extracting.Which.Subjects___Which.Dont.Have.Nii(MT1Img_path, MT1Img_folders)
