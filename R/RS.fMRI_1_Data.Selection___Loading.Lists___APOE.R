RS.fMRI_1_Data.Selection___Loading.Lists___APOE = function(Selected_RID, Subjects_APOE, path_Subjects.Lists_Downloaded){
  #=============================================================================
  # csv?
  #=============================================================================
  path_Subjects = paste0(path_tail_slash(path_Subjects.Lists_Downloaded), Subjects_APOE)
  ...
  selected_cols = c("PHASE", "RID", "VISCODE", "USERDATE", "USERDATE2", "APGEN1", "APGEN2")
  Data_Intersect_Selected.df = Data_Intersect.df %>% select(all_of(selected_cols))
  selected_cols_2 = c("USERDATE", "USERDATE2", "APGEN1", "APGEN2")
  Data_Intersect_Selected.df = change_colnames(Data_Intersect_Selected.df, from = selected_cols_2, to = paste0("APOE___", selected_cols_2))
