RS.fMRI_1.3_Exporting.List___Combine.by.Manufacturer = function(data.list){
  #===============================================================================
  # Data load
  #===============================================================================
  EPB = data.list[[1]]
  MT1 = data.list[[2]]
  EPB = EPB %>% dplyr::rename(SERIES_DESCRIPTION = DESCRIPTION)
  MT1 = MT1 %>% dplyr::rename(SERIES_DESCRIPTION = DESCRIPTION)
