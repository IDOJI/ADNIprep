RS.fMRI_4.2_Extracting.Results___Pearson.Correlation = function(path_ROISignals){
  ...
  Corr.list = lapply(index, FUN=function(ith_index, ...){
    ...
    ith_Corr_files = filter_by(list.files(ith_results_folder), including.words = c("Correlation", "\\.txt"), excluding.words = "FisherZ")
